...
public class listsExceercieses {

    public static void main(String[] args) {
        Scanner scan = new Scanner(System.in);

        int[] intInputArr = Arrays.stream(scan.nextLine().split(" ")).mapToInt(e -> Integer.parseInt(e)).toArray();
        ...
        String strInput = "";
        while (!(strInput = scan.nextLine().toLowerCase()).equals("end")) {
